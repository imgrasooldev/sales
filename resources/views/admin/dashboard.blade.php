                ...
                <div class="mainWrap">
                    <div class="container">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td scope="row">
                                            <span>
                                                <a href="{{ Route('admin.user_profile', $user->id) }}">
                                        ...
                                        @if($per <= 70) @php $perClass="red" ; @endphp @elseif ($per> 70 && $per <= 85) @php $perClass="yellow" ; @endphp @else @php $perClass="green" ; @endphp @endif <td class="{{ $perClass }} text-center">{{ (int) $per }}%</td>
                        ...
                        <div class="allpaid">
                            ...
                            <table id="leadsTable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $counter }}</td>
                                        <td><a href="{{ Route('admin.pdf', $payment->id) }}">Download</a></td>
                        ...
                        <div class="allpaid">
                            ...
                            <table id="unpaidleadsTable" class="table table-striped table-bordered" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>Sr #</th>
                                        <th>Date / Time</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $payment->agent_name }}</td>
                                        <td>{{ $payment->brand_name }}</td>
                                        <td><button class="copyLink" data="https://pay.amazelogo.com/payment/<?php echo $payment->link ?>">Payment Link</button></td>
                                    </tr>
                                    @php
                                    $counter++;
                                    @endphp
