...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('public/assets/admin/vendors/simple-line-icons/css/simple-line-icons.css') }}"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('public/assets/admin/vendors/daterangepicker/daterangepicker.css') }}"
    />
