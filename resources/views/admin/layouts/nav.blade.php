...
>
 <div class="navbar-brand-wrapper d-flex align-items-center">
   <a class="navbar-brand brand-logo" href="{{ Route('admin.dashboard') }}">
     <img src="{{ asset('public/assets/admin/images/logo.svg') }}" alt="logo" class="logo-dark" />
   </a>
   <a class="navbar-brand brand-logo-mini" href="{{ Route('admin.dashboard') }}"
     ><img src="{{ asset('public/assets/admin/images/logo-mini.svg') }}" alt="logo"
   /></a>
 </div>
       ...
       >
         ...
         <a class="dropdown-item preview-item">
           <div class="preview-thumbnail">
             <img
               src="{{ asset('public/assets/admin/images/faces/face10.jpg') }}"
               alt="image"
         ...
         <a class="dropdown-item preview-item">
           <div class="preview-thumbnail">
             <img
               src="{{ asset('public/assets/admin/images/faces/face12.jpg') }}"
               alt="image"
               class="img-sm profile-pic"
             />
           </div>
         ...
         <a class="dropdown-item preview-item">
           <div class="preview-thumbnail">
             <img
               src="{{ asset('public/assets/admin/images/faces/face1.jpg') }}"
               alt="image"
               class="img-sm profile-pic"
             />
           </div>
     ...
     <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
       ...
       >
         <img
           ...
           src="{{ asset('public/assets/admin/images/faces/face23.jpg') }}"
           alt="Profile image"
         />
