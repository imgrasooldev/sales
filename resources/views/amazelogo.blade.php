...
<body style="background: url('{{ public_path().'/assets/bgamazelogo.jpg' }}'); background-size: cover; background-position: center ">
    <div>
        <img style="width: 30%; height: 20vh; margin-top: 40px; margin-left: 400px" src="{{ public_path().'/assets/amazelogo.png' }}">
    </div>
    <div style="margin-top: -10px; margin-left: 60px;">
        <table>
            <tr>
                <td style="width: 340px">
                    <img style="width: 280px; margin-top: 55px" src="{{ public_path().'/assets/amazelogoinvoice.png' }}" />
                </td>
                <td>
    ...
    <div class="width: 100%; text-align: center;">
        <table style="width: 85%; margin-top: 40px; margin-left: 60px;border-spacing:0px;">
            <thead style="background-color:#639669;">
            ...
            <tbody>
                ...
                <tr style="background-color: #AACEAA;">
